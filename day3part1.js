 ...
 * @returns {number} The closest distance of the intersection
 */
const calculateClosestDistance = (wire1Definition, wire2Definition) => {
    ...
    const closestDistance = intersections.map(calculateDistance).sort((x,y) => x-y)[0];
...
if (require.main === module) {
    ...
    const closestDistance = calculateClosestDistance(wire1Definition, wire2Definition);
